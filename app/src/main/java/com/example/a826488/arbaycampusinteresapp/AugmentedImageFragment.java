...
import com.example.a826488.arbaycampusinteresapp.helpers.SnackbarHelper;
...
public class AugmentedImageFragment extends ArFragment {
    ...
    // matching. private static final String DEFAULT_IMAGE_NAME = "default.jpg";
    private static final String LEAFLET_IMAGE_NAME = "leaflet.jpg";
    private static final String SIGN_COFO_IMAGE_NAME = "signcofo.jpg";
    ...
    private boolean setupAugmentedImageDatabase(Config config, Session session) {
        ...
        if (USE_SINGLE_IMAGE) {
            ...
            augmentedImageDatabase.addImage(LEAFLET_IMAGE_NAME, augmentedImageBitmap);
            augmentedImageDatabase.addImage(SIGN_COFO_IMAGE_NAME, augmentedImageBitmap);
